...
# remotes::install_github("tadhg-moore/flare-1") # Tadhg's repo
...
# Set start & end dates 
run_config$start_day_local <- "2020-04-01"
run_config$end_day_local <- "2020-09-08"
run_config$forecast_start_day_local <- "2020-09-09"
run_config$forecast_horizon <- 7
